...
# 插入电影表数据
INSERT_TABLE_MOVIE_STATEMENT = "INSERT INTO movie (movie_id, movie_name, movie_description, release_year, cover_image_url, rating, share_link) VALUES (?, ?, ?, ?, ?, ?, ?)"
# 根据id查询电影
...
# 插入剧集表数据
INSERT_TABLE_SHOW_STATEMENT = "INSERT INTO show (show_id, show_name, show_description, release_year, cover_image_url, rating, share_link) VALUES (?, ?, ?, ?, ?, ?, ?)"
